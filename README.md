...
- ~~haven't set up OC Boot Picker as i don't need it~~ i'm dualbooting now, already set up
...
- computer would reboot a few times during install, choose `macOS Installer`
